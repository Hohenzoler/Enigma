...
class M1:
    ...
    def Individual_Input(self, s):
        ...
        pos4 = chr(self.Rotors[0].index(reflected) + self.character_offset_factor)
        print(pos4)

        pos5 = chr(self.Rotors[1].index(pos4) + self.character_offset_factor)
        print(pos5)

        pos6 = chr(self.Rotors[2].index(pos5) + self.character_offset_factor)
        print(pos6)




machine = M1([I, II, III], [0, 0, 1], UKW_B)
